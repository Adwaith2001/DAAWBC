...
# CONFIG
# ======================================================
NUM_AGENTS = 3          # ✅ THREE ADVERTISERS
BUDGET = 1000.0
MAX_STEPS = 5000
EPISODES = 10
...
for ep in range(1, EPISODES + 1):
    ...
    print(
        f"Episode {ep:02d} | "
        f"{reward_str} | "
        f"Costs={env.costs} | Clicks={env.clicks}"
    )

print("\n✅ Multi-advertiser (3-agent) training completed successfully")
