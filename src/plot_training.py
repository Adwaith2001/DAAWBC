...
plt.xlabel("Episode")
plt.ylabel("Clicks")
plt.title("REINFORCE: Mean ± Std Clicks")
plt.legend()
plt.tight_layout()

clicks_path = OUT_DIR / "reinforce_clicks_mean_std.png"
...
plt.xlabel("Episode")
plt.ylabel("Return")
plt.title("REINFORCE: Mean ± Std Return")
plt.legend()
plt.tight_layout()

returns_path = OUT_DIR / "reinforce_return_mean_std.png"
